...
public class DateUtils {
    ...
    public static final String week() {
        ...
        int w = getCalendar().get(Calendar.DAY_OF_WEEK) - 1;
        if (w < 0)
            w = 0;
        return weekDays[w];
     ...
     * @return
     */
    public static final String week(int days) {
        String[] weekDays = {"星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"};
        String strDate = add(Calendar.DATE, days);
        Date date = convertString2Date(strDate);
        int w = getCalendar(date).get(Calendar.DAY_OF_WEEK) - 1;
        if (w < 0)
            w = 0;
        return weekDays[w];
    ...
    public static class Lunar {
         ...
         *
         * @param year	农历年份
         * @param year	1：属相年，2：属相年，默认：天干地支+属相年
         * @return
         */
