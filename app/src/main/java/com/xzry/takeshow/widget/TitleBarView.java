...
public class TitleBarView extends RelativeLayout implements View.OnClickListener{
    ...
    protected ExpandImageView avatarImg;
    protected TextView titleView;
    protected TextView rightText;
    protected TextView rightText2;
    protected LinearLayout titleLayout;
    protected View infore_sign;
    protected BtnClickListener listener;
    ...
    private void init(Context context, AttributeSet attrs){
        LayoutInflater.from(context).inflate(R.layout.a_titlebar,this);
        leftLayout = (RelativeLayout) findViewById(R.id.left_layout);
        leftImage = (ImageView) findViewById(R.id.titlebar_left_img);
        rightLayout = (RelativeLayout) findViewById(R.id.right_layout);
        rightImage = (ImageView) findViewById(R.id.titlebar_right_img);
        ...
        infore_sign = (TextView) findViewById(R.id.infore_sign);
        rightText = (TextView) findViewById(R.id.titlebar_right_text);
        rightText2 = (TextView) findViewById(R.id.titlebar_right_text2);
        avatarImg = (ExpandImageView) findViewById(R.id.avatar_img);
    ...
    public void setAvatarImgVisibility(int visibility){
        avatarImg.setVisibility(visibility);
    }

    public ExpandImageView getAvatarImg(){
        return avatarImg;
    }

    public void setInforeSignVisibility(int visibility){
        infore_sign.setVisibility(visibility);
    }
